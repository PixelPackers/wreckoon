...
public class DumbPig extends Enemy {
	...
	public DumbPig(Game game, float posX, float posY, float width, float height, float density, float friction, float restitution,
	...
	public void update() {
		...
		if (!isDead() && !dizzy && !getsGrilled) {
			...
			if (this.isOnGround() && !idle) {
				...
				// this.body.applyLinearImpulse( new Vec2(speed,
